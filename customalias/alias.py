...
class Alias(commands.Cog):
    ...
    @customalias.group(name="global")
    async def global_(self, ctx: commands.Context):
        """Manage global aliases."""
        pass

    @checks.mod_or_permissions(manage_guild=True)
    @customalias.command(name="add")
    @commands.guild_only()
    ...
    @checks.mod_or_permissions(manage_guild=True)
    @customalias.command(name="delete", aliases=["del", "remove"])
    @commands.guild_only()
